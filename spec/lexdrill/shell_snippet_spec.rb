...
RSpec.describe Lexdrill::ShellSnippet do
  describe ".for" do
    it "returns the zsh snippet with a precmd hook and an idempotency guard" do
    ...
    it "returns the bash snippet with a PROMPT_COMMAND hook and an idempotency guard" do
